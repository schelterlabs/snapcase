...
use crate::vsknn::types::{SessionId, ItemId, SessionItemWithOrder};
use fnv::FnvHasher;
use std::fs::File;
...
pub fn read_evolving_sessions_partitioned(
    ...
    let evolving_sessions: HashMap<SessionId, Vec<ItemId>> = evolving_session_interactions
        ...
        .map(|(session_id, mut item_ids_with_order)| {
            ...
            let session_items: Vec<u32>  = item_ids_with_order.into_iter()
...
pub fn read_historical_sessions(historical_sessions_file: &str) -> Vec<(u32, u32, u32)> {
